                ...
                <div className="max-w-[800px] mx-auto text-center space-y-8 mb-20">
                    <div className="space-y-6">
                        ...
                        <p className="text-xl text-muted-foreground max-w-[600px] mx-auto">
                            Streamline your projects with our intuitive project management tool. 
                            Collaborate, track, and deliver with ease.
                        </p>
                    </div>

                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button size="lg" asChild>
                            <Link href="/create-account" className="gap-2 flex items-center">
